...
class Dots {
  ...
  class Circuits {
    ...
    populate() {
      ...
      y1 = Math.floor($logo.offset().top / size),
  ...
  class Things {
    ...
    draw() {
      ...
      if (!circuits.drawWholeBackground) {
        const circuitsLayer = circuits.draw();
  ...
  class Background {
    ...
    getBackground(showCircuits) {
      ...
      if (showCircuits && circuits.canvas) {
  ...
  // background draw
  function drawBackground(includeCircuits) {
  ...
  function resize() {
    (width = bgCanvas.width = $(bgCanvas).innerWidth()),
      (height = bgCanvas.height = $(bgCanvas).height()),
      (redrawBackground = true);
  }
  ...
  function loop() {
    ...
    if (redrawBackground) {
      drawBackground(circuits.drawWholeBackground);
    }
